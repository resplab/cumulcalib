...
```
You can also install the *development* version, including the individualized treatment effect (ITE) functionality, from the `cumulcalibITE` branch on [GitHub](https://github.com/) with:
