...
In order to use _cumulcalib_ efficiently you should be reasonably familiar with the underlying statistical methodology. Please visit the related publication (Sadatsafavi and Petkau, Statistics in Medicine, 2024 https://doi.org/10.1002/sim.10138). 
